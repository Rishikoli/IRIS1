...
@router.get("/{company_id}/m-score", response_model=BeneishMScoreResponse)
...
@router.get("/{company_id}/anomalies", response_model=AnomalyDetectionResponse)
...
@router.get("/{company_id}/benford", response_model=BenfordAnalysisResponse)
